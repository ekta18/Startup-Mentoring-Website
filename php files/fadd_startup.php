...
-->
    ...
    <div class="title">
       ...
       <?php 
        ...
        ?>
       <a href="funder.php" id="add-button">Funder's Desk</a>
    </div>
    ...
    <?php 
         ...
         $tname = array();
         $tinfo = array();
         $sql = "SELECT Tname,Tproject,Tstatus FROM team;";
            $results = $conn->query($sql);
            if (!empty($results) && $results->num_rows > 0) 
            {
                while ($row = $results->fetch_assoc()) 
    ...
    <div class="main-body">
      ...
      <div class="accordion" id="accordionExample">
         <?php 
              ...
              for ($i=0; $i < $tmlen; $i++) 
              { 
                  echo '<form action="fadd_startup.php" method="POST">';
                  echo '<div class="card">';
              ...
              echo '<script type="text/javascript">';  
                        echo 'window.location.href = "pfadd_startup.php";';
                        echo '</script>';
              }
          ?>
