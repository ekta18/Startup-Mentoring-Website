<?php 
    ...
    $sql = "SELECT Tid FROM mentorteam WHERE Mid='$mid';";
    $results = $conn->query($sql);
    if (!empty($results) && $results->num_rows > 0) 
    {
        while ($row = $results->fetch_assoc()) 
...
<body>
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="domainpage1.php">Software</a>
...
-->
        ...
        <?php 
           ...
           echo '</li>';
               ...
               else
              {
                // $_SESSION["mentid"] = $mid;
                echo '<li class="nav-item">';
                    echo '<a href="mentor_domain.php">Choose Your Domain</a>';
                  echo '</li>';
                echo '<li class="nav-item">';
    ...
    <div class="title">
      <?php 
          echo '<strong><p id="heading">Mentor Desk</p></strong>';
